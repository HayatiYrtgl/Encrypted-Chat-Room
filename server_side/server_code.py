        ...
        try:
            ...
            if "code_all" in message:
                ...
                with open("crypto_send_files/serverkey.key", "rb") as key:
                    ...
                    client.send("###şifre anahtarı gönderildi".encode("utf-8"))
                ...
                with open("crypto_send_files/encrypted_dictionary.txt", "rb") as crypto_dict:
                    ...
                    # sending message to client and close it connection

                    client.send("###şifreli Sözlük Gönderildi\n"
                                "###client'ı kapatıp yeniden aç!".encode("utf-8"))
                    client.close()
